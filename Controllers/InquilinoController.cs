...
public class InquilinoController : Controller
{
    ...
    public InquilinoController(ILogger<PersonaController> logger)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> ObtenerDataTable()
    {
        try
        {
            ...
            var (personas, total) = await _inquilinoService.ObtenerTodosAsync(page, pageSize, searchValue);

            // URL de retorno para los botones de acción
            var returnUrl = Url.Action("Index", "Inquilino");
