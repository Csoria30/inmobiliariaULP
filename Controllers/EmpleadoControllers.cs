...
public class EmpleadoController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        catch (Exception ex)
        {
            ...
            return View(new List<Empleado>()); // Vista vacía con error
        }
    }
    ...
    public async Task<IActionResult> ObtenerDataTable()
    {
        try
        {
            ...
            var (personas, total) = await _empleadoService.ObtenerTodosAsync(page, pageSize, searchValue);

            // URL de retorno para los botones de acción
            var returnUrl = Url.Action("Index", "Empleado");
